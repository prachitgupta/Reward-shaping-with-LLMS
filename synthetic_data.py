...
if __name__ == "__main__":
    ...
    # )
    generate_dataset_with_claude_for_specific_actions(env = env, num_episodes=10, max_steps=5, file_name1="datasets_episodes_extreme_lanes.csv", file_name2="datasets_collision_free_extreme_lanes.csv")
